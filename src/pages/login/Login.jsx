  ...
  return (
    ...
    >
      <div className=" bg-opacity-10 backdrop-blur-md rounded-xl shadow-2xl p-8 md:p-12 w-full max-w-md text-white">
        <h2 className="text-2xl font-bold text-center mb-6">Already Have an Account</h2>
        ...
        <p className="mt-6 text-center text-sm text-gray-200">
          Don't have an account? <Link to='/auth/signup'><span  className="text-teal-300 hover:underline cursor-pointer">Signup</span></Link>
        </p>
      </div>
    </div>
  );
